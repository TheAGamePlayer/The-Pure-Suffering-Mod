...
public final class InvasionLevelData extends SavedData {
	...
	public static final void factory(final ServerLevel pLevel) {
		pLevel.getDataStorage().computeIfAbsent(data -> load(pLevel, data), () -> new InvasionLevelData(pLevel), getFileId(pLevel.dimensionTypeRegistration()));
	}
	...
	@Override
	public CompoundTag save(final CompoundTag pNbt) {
