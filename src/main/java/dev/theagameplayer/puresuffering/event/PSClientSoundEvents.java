...
public final class PSClientSoundEvents {
	...
	public static final void playStreamingSource(final PlayStreamingSourceEvent pEvent) {
		...
		final boolean flag1 = PSSoundEvents.INFORM_INVASION.value().getLocation().getPath().equals(name) || PSSoundEvents.INVASION_AMBIENCE.value().getLocation().getPath().equals(name);
		final boolean flag2 = PSSoundEvents.CANCEL_INVASION.value().getLocation().getPath().equals(name) || InvasionDifficulty.DEFAULT.getStartSound().getLocation().getPath().equals(name) || InvasionDifficulty.HYPER.getStartSound().getLocation().getPath().equals(name) || InvasionDifficulty.NIGHTMARE.getStartSound().getLocation().getPath().equals(name);
