...
public final class PSMobEffects {
	...
	public static final DeferredHolder<MobEffect, BlessingMobEffect> BLESSING = MOB_EFFECT.register("blessing", () -> new BlessingMobEffect(MobEffectCategory.BENEFICIAL, Color.WHITE.getRGB()));
}